...
export const Projects: React.FC = () => {
  ...
  const techs = ['All', ...Array.from(new Set(projects.flatMap(p => p.techStack || [])))];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-slate-600 max-w-2xl mx-auto">
            Live applications running on scalable infrastructure, now persisted on Neon Serverless Postgres.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {loading ? (
            ...
            filteredProjects.map((project) => (
              <div key={project.id} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-shadow group flex flex-col">
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <p className="text-slate-600 mb-6 flex-1 line-clamp-2">{project.description}</p>
